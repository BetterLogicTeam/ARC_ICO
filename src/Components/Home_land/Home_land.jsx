        ...
        <div className="row">
          <div className="col-md-7 left_connent text-start">
            ...
            <p className="home_land_para text-white">
              Buy ARC and WARC With USDT token at a very discounted price in the Presale. Swap
              USDT for ARC and WARC without any fees at the lowest price. During the
              Presale ARC and WARC is available for only 1 USDT compared to the public
              sale for 1.53 USDT.
            </p>
                  ...
                  <>
                    ...
                    <div className="d-flex justify-content-center my-4">
                      ...
                      >
                        ...
                        <span _ngcontent-bhd-c59="">Buy WARC</span>
                      </button>
                      {/* <button
                        onClick={() => setModalShow2(true)}
                        className="connect_to_wallet_home iso_btn"
